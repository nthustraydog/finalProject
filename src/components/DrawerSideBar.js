    ...
    render() {
      ...
      return (
        <Container style={styles.drawer}>
            ...
            <Button block transparent style={styles.item} onPress={() => navigate('校園狗狗們')}>
                <Icon name='rocket' style={styles.icon} />
                <Text style={styles.text}>校園常見狗狗</Text>
                <Badge primary style={styles.badge}>
                    <NbText style={styles.badgeText}>2</NbText>
                </Badge>
            </Button>
            <Button block transparent style={styles.item} onPress={() => navigate('活動')}>
                <Icon name='tag-multiple' style={styles.icon} />
                <Text style={styles.text}>認養專頁</Text>
            </Button>
