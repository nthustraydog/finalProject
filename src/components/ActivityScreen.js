        ...
        return (
            <NavHeader navigate={navigate} goBack={goBack} title='活動資訊'>
              <ScrollView>
                ...
                <View style={{width:360,alignItems:'center',backgroundColor:'#C10066'}}>
                 ...
                 <HideableView visible={this.state.q1} style={{height:this.state.q1?null:0}}>
                    <View style={{width:354,backgroundColor:'white'}}>
                ...
                <View style={{width:360,alignItems:'center',backgroundColor:'#7744FF'}}>
           ...
           <View style={{width:360,alignItems:'center',backgroundColor:'#668800'}}>
              <Text style={{color:'white',fontSize:20}} onPress={()=>
                  this.setState({
                  q3:!this.state.q3
              })}>      懷生講座      09/5(四)</Text>
          ...
          <View style={{width:360,alignItems:'center',backgroundColor:'#FF5511'}}>
             <Text style={{color:'white',fontSize:20}} onPress={()=>
                 this.setState({
                 q4:!this.state.q4
             })}>      竹蜻蜓綠市集    10/8(六)</Text>
